...
class ENDFHeadRecordUnitTest(unittest.TestCase):
    def setUp(self):
        self.record = sp.ENDFHeadRecord()
    ...
    def test_readLine(self):
        ...
        self.assertEqual(9.47990e+08, self.record.ZA, "Assert ZA")
        self.assertEqual(9.46728e+05, self.record.AWR, "Assert AWR")
    ...
    def test_readLine2(self):
        ...
        self.assertEqual(2, self.record.NS, "Assert NS")
        self.assertEqual(0.0, self.record.ZA, "Assert ZA")
        self.assertEqual(0.0, self.record.AWR, "Assert AWR")
        self.assertEqual(0, self.record.L1, "Assert L1")
        self.assertEqual(0, self.record.L2, "Assert L2")
